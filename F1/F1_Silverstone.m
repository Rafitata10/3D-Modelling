...
stlFile = 'C:/Users/rafar/OneDrive - Universidad de Málaga/Escritorio/University/Matlab/F1/sources/silverstone_circuit.stl';

% Leer el archivo STL.
fv = stlread(stlFile); % Leer el archivo STL como una estructura de vértices y caras.

% Visualización del circuito de Silverstone.
figure('Name', 'Circuito de Silverstone 3D', 'NumberTitle', 'off', 'Color', [1 1 1]);
...
ylabel('Y');
zlabel('Z');
title('Circuito de Silverstone en 3D');
...
%% Finalizar el script.
disp('Visualización del circuito de Silverstone completada.');
