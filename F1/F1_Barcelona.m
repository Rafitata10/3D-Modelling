...
stlFile = 'C:/Users/rafar/OneDrive - Universidad de Málaga/Escritorio/University/Matlab/F1/sources/barcelona_circuit.stl';

% Leer el archivo STL.
fv = stlread(stlFile); % Leer el archivo STL como una estructura de vértices y caras.

% Visualización del circuito de Barcelona.
figure('Name', 'Circuito de Barcelona 3D', 'NumberTitle', 'off', 'Color', [1 1 1]);
...
ylabel('Y');
zlabel('Z');
title('Circuito de Barcelona en 3D');
...
%% Finalizar el script.
disp('Visualización del circuito de Barcelona completada.');
